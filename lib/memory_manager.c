...
static void
sshc_memory_context_init (sshc_memory_context_t *ctx, const char *label)
{
...
static sshc_memory_context_t *
sshc_memory_context_global (void)
{
...
static void
sshc_memory_registry_remove (sshc_memory_allocation_t *allocation)
{
  pthread_mutex_lock (&sshc_registry_mutex);
...
static void
sshc_memory_registry_add (sshc_memory_allocation_t *allocation)
{
  pthread_mutex_lock (&sshc_registry_mutex);
...
static void *
sshc_memory_context_alloc (sshc_memory_context_t *ctx, size_t size, bool zero)
{
  if (ctx == NULL) {
