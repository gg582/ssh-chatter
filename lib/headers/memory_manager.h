...
static inline sshc_memory_context_t *sshc_memory_context_create(const char *label) {
  (void)label;
  return NULL;
}
...
static inline sshc_memory_context_t *sshc_memory_context_push(sshc_memory_context_t *ctx) {
  (void)ctx;
  return NULL;
}
