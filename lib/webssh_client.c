...
static void
webssh_client_on_message (client_connection_t *connection,
...
static void
webssh_client_on_detach (client_connection_t *connection)
{
  (void)connection;
}

webssh_client_t *
webssh_client_create (struct host *host, client_manager_t *manager)
{
...
void
webssh_client_destroy (webssh_client_t *client)
{
  if (client == NULL) {
    return;
  }
...
size_t
webssh_client_snapshot (webssh_client_t *client, chat_history_entry_t *buffer,
                        size_t capacity)
{
...
bool
webssh_client_send_message (webssh_client_t *client, const char *username,
                            const char *message)
{
